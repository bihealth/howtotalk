...
ggplot(power, aes(x = n_samples_tot, y = power, color = factor(d))) +
  geom_point() +
  geom_line() +
  scale_color_brewer(palette = "Dark2", name="Effect size",
    guide=guide_legend(reverse=TRUE)) +
  scale_x_log10() +
  labs(x = "Number of samples (total)", y = "Power")
...
ggplot(power_tot, aes(x = n_samples_tot, y = power, color = factor(d))) +
  geom_point() +
  geom_line() +
  scale_color_brewer(palette = "Dark2", name="Effect size",
    guide=guide_legend(reverse=TRUE)) +
 ...
 * Evaluate existing data - is the assay able to answer your questions?
...
::: {.callout-tip}
## Bottom line
 Work with a-priori hypotheses whenever you can!
:::
